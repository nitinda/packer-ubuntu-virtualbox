# #!/bin/sh -eux
sudo dpkg --list | awk '{ print $2 }' | egrep -i -- 'firefox|simple-scan|-sudoku|Aisleriot|-Mahjongg|-Mines|Thunderbird|libreoffice-|shotwell|remmina' | sudo xargs apt-get -y purge
